-- V35: CRM Seed Data and Configuration
...
-- Note: Replace 'app_user' with actual application database user
-- GRANT SELECT, INSERT, UPDATE, DELETE ON leads TO app_user;
-- GRANT SELECT, INSERT, UPDATE, DELETE ON demo_requests TO app_user;
...
-- GRANT SELECT ON crm_settings TO app_user;
-- GRANT INSERT ON crm_audit_log TO app_user;
